# - Sur base d’un CSV dont vous définissez et documentez la structure, créer
# automatiquement des comptes utilisateurs Active Directory

import csv
from active_directory import create_user
...
with open("users.csv", "r") as csv_file:
    ...
    for row in csv_reader:
        ...
        last_name = row[3]
        email = row[4]
        # Crée un compte utilisateur dans Active Directory en utilisant l'API Active Directory
        create_user(username, password, first_name, last_name, email)


# Dans cet exemple, le fichier CSV doit avoir la structure suivante :
